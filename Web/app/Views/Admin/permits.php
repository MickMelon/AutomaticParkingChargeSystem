<h4>Hourly Rate</h4>
<form action="index.php?controller=admin&action=updatehourlyrate" method="post">
    <div class="form-group">
        <label for="first">Hourly Rate:</label>
        <input type="price" name="price" class="form-control" id="price" value="<?= $hourlyRate ?>" minlength="0.00" maxlength="1000.00" step="0.01" required>
...
<form action="index.php?controller=admin&action=updatepermitprice" method="post">
    <div class="form-group">
        ...
        <input type="price" name="price" class="form-control" id="price" value="<?= $permitPrice ?>" minlength="0.00" maxlength="1000.00" step="0.01" required>
        <small id="price" class="form-text text-muted">Caution: This changes the monthly parking permit price.</small>
    </div>
